...
require_once "/var/www/html/php/login/v3/log/log.php";
...
<?php
	...
	if(isset($_POST['username']))
	{
		...
		exec('rm -r /var/www/html/php/login/v3/cloud/'.$username_td);
		exec('rm -r /var/www/html/php/login/v3/voctr/'.$username_td);
		exec('rm /var/www/html/php/login/v3/php/schulnetz/id/'.$username_td.'.id');
		exec('rm -r /var/www/html/php/login/v3/php/schulnetz/users/'.$username_td);
